...
public class SignupCodeVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signup_code_verification);
...
//                    startActivity(new Intent(SignupCodeVerification.this, SignupPersonalInformation.class));
//                }
//
//                @Override
