...
public class Borrow {
    ...
    public Borrow(int bid, int iid, int lock_id, int vid, char target, char phase, Date start_d, Date end_d, float payment, float number, int complete, int finished, String itemName, String itemRate, String itemOwner) {
        this.bid = bid;
        this.iid = iid;
